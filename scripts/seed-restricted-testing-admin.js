...
const TESTING_SIDEBAR_ACCESS = Object.freeze([
  ...
  // HR Management is intentionally limited for the delegated Testing Admin.
  // Attendance, availability, leave, leave balances, payroll and development
  // are excluded from both the sidebar and direct navigation.
  '/dashboard/hr',
  ...
  // Admin-namespaced OPD/IPD billing routes added by the billing follow-up.
  '/dashboard/admin/finance/billing*',
  '/dashboard/admin/finance/ipd*',
