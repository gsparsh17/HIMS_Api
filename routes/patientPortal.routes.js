...
router.post('/auth/email/request-otp', auth.emailRequestOtp);
router.post('/auth/email/verify-otp', auth.emailVerifyOtp);
router.post('/auth/phr/select-user', auth.phrSelectUser);
router.post('/auth/password', auth.passwordLogin);
...
router.post('/abdm/profile/request-otp', portal.requestPhrProfileOtp);
router.post('/abdm/profile/verify-otp', portal.verifyPhrProfileOtp);
router.post('/abdm/profile/password', portal.updatePhrPassword);
router.get('/abdm/profile', portal.getPhrProfile);
router.patch('/abdm/profile', portal.updatePhrProfile);
router.get('/abdm/profile/qr-code', portal.getPhrQrCode);
router.get('/abdm/profile/phr-card', portal.getPhrCard);
router.post('/abdm/profile-share', portal.abdmProfileShare);
router.post('/abdm/running-token/status', portal.abdmRunningTokenStatus);
