...
router.patch('/ipd/:admissionId/charges/:chargeId/reverse', requireModuleAccess('billing_finance', 'manage'), requireActionPermission('billing_delete_charge'), finance.reverseInvoicedIPDCharge);
