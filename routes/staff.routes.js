...
router.get('/:id/login-access', protect, requireModuleAccess('hr_staff', 'manage'), requireActionPermission('user_access_manage'), staffController.getStaffLoginAccess);
router.put('/:id/login-access', protect, requireModuleAccess('hr_staff', 'manage'), requireActionPermission('user_access_manage'), staffController.updateStaffLoginAccess);
