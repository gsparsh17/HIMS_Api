...
otRequestSchema.index({ hospitalId: 1, status: 1, closedAt: -1 });
otRequestSchema.index({ hospitalId: 1, primarySurgeonId: 1, status: 1, closedAt: -1 });
otRequestSchema.index({ hospitalId: 1, procedureId: 1, status: 1, closedAt: -1 });
