...
const schema = new mongoose.Schema(
  {
    ...
    integrityValidated: { type: Boolean, default: false },
    cryptographicallyValidated: { type: Boolean, default: false, index: true },
    validationId: { type: String, index: true },
    validatedAt: Date,
    validFrom: Date,
    verifiedScope: mongoose.Schema.Types.Mixed,
    trustEvidence: mongoose.Schema.Types.Mixed,
    retentionUntil: Date,
    grantedAt: Date,
    expiresAt: Date,
    revokedAt: Date,
